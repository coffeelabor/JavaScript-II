...
let allCaps = runners.map(upperName => upperName.first_name.toUpperCase());

// function upperName(first){
//     return runners.first_name.toUpperCase
// }
// runners.map(upperName =>{
//     allCaps.push(upperName.first_name.toUpperCase)
// })
...
let largeShirts = runners.filter(lShirt => lShirt.);
